...
import { faWifi, faVolumeMute, faBatteryHalf } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <Box backgroundColor='rgba(255,255,255,0.3)' style={{backdropFilter: 'blur(10px)'}}>
      <Stack direction='row' spacing={5} ml={5}>
        ...
        <Spacer />
        <Menu>
          <MenuButton><FontAwesomeIcon icon={faVolumeMute} /></MenuButton>
          <MenuButton><FontAwesomeIcon icon={faBatteryHalf} /></MenuButton>
          <MenuButton><FontAwesomeIcon icon={faWifi} /></MenuButton>
        </Menu>
        <Text mr={5}>{time}</Text>
      </Stack>
    </Box>
